...
class RequestHandler:
    ...
    def __init__(self):
        useragent = 'Default user agent' # This will be set by RedditUser
    ...
    def getresponse(self, request):
        ...
        while attemptsremaining > 0:
            try:
                ...
                print 'Error code: %d. Retrying in a few seconds...' % e.code
                time.sleep(5)
                attemptsremaining -= 1
        if attemptsremaining == 0:
            print 'Sorry, it doesn\'t seem to be working.'
            exit(1)
